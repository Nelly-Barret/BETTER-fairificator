...
class TestExtract(TestCase):
    ...
    def test_load_existing_data_in_memory(self):
        ...
        database.insert_many_tuples(TableNames.PATIENT.value, [patient1.to_json(), patient2.to_json(), patient3.to_json()])
        database.insert_many_tuples(TableNames.HOSPITAL.value, [hospital1.to_json(), hospital2.to_json()])
        database.insert_many_tuples(TableNames.EXAMINATION.value, [examination1.to_json(), examination2.to_json()])
